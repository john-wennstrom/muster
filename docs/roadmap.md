...
- [ ] **Unwired:** connect run/phase/role/task budget evaluation to live usage and forecasts before dispatch. Optional debate/opinions may be reduced; mandatory review/tests/validation must block explicitly rather than disappear.
