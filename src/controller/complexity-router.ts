...
export function orchestrationPolicy(
  classification: ChangeComplexity,
  budget: { optionalBudgetAvailable: boolean },
): OrchestrationPolicy {
  const optionalEligible = classification === "architectural";
  const optionalEnabled = optionalEligible && budget.optionalBudgetAvailable;
  return Object.freeze({
    classification,
    ...
    optional: Object.freeze({
      specialistOpinions: optionalEnabled,
      debate: optionalEnabled,
    }),
