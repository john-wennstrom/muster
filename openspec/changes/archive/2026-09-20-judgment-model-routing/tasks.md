...
- [x] 3.2 Run the full validation set and compare pass and fail counts against the recorded pre-existing platform baseline, confirming that every task uses the primary builder exactly as today with the flag or the override unset and that judgment disabled performs no routing work.
